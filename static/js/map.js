          ...
          if (bannedList.includes(path.id)) {
            ...
            const handleModal = async () => {
              try {
                ...
                document.getElementById("bannedModalLabel").innerText =
                  pathTitle;
                document.getElementById("modal-body-country-name").innerText =
                  pathTitle;
                document.getElementById("modal-criminalization").innerText =
                  countryData
                    ? countryData.criminalization
                    : "Data not available";
                document.getElementById("modal-max-penalty").innerText =
                  countryData ? countryData.maxPenalty : "Data not available";

                const tooltipInstance = bootstrap.Tooltip.getInstance(path);
                if (tooltipInstance) {
                  tooltipInstance.hide();
                }
